...
$header="<html>
         <head>
         <title> listing LIGNES DE FACTURES Octal ". $BASE." </title>
...
$szListe = "<P1> BASE : ".$BASE." Lignes de FACTURES </P1>
...
facl_dt_saisie,
blcl_gare as GROF,
orfa_dt_validation as dt_chiffrage,
orfa_pers_initiale_validation as pers_chiffrage,
facl.*,
cdcl_reference_client,
lccl_user_a1
FROM
ligne_facture_client facl
join
facture_client
on facl_numero=lfcl_facl_numero
left join
bl_client
on
blcl_numero=lfcl_blcl_numero
join client
on facl_clnt_code=clnt_code
left join ligne_cde_client
on lfcl_cdcl_numero=lccl_cdcl_numero and lfcl_lccl_ligne=lccl_ligne
left join ordre_fabrication
on orfa_numero=lccl_orfa_numero
left join cde_client
on cdcl_numero = lccl_cdcl_numero";
